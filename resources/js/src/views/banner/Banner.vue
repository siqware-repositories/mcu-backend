<template>
    <vx-card no-shadow>
        <div class="flex btn-group">
            <vs-button @click="$refs.addBanner.show()" type="relief" icon-pack="feather" icon="icon-plus-square">
                បន្ថែម
            </vs-button>
            <vs-button v-if="selected.length===1" @click="$refs.editBanner.show(selected[0])" color="warning"
                       type="relief" icon-pack="feather" icon="icon-edit">កែប្រែ
            </vs-button>
            <vs-button v-if="selected.length===1" @click="toggleBannerStatus" color="dark" type="relief"
                       icon-pack="feather" icon="icon-check">Active
            </vs-button>
            <vs-button v-if="selected.length" @click="destroyBanner" color="danger" type="relief" icon-pack="feather"
                       icon="icon-trash-2">លុប
            </vs-button>
        </div>
